# Reporte Técnico de Optimización Numérica y Combinatoria
...
**Repositorio de código:** [https://github.com/Emmanuell87/Heuristic-Optimization](https://github.com/Emmanuell87/Heuristic-Optimization)

## Integrantes e información de coautoría

- **Jean Carlos Perilla García -** [jperillag@unal.edu.co](mailto:jperillag@unal.edu.co) — Desarrollo y calibración de los algoritmos evolutivos y heurísticos continuos (GA, PSO, DE) de la Parte 1; redacción y diseño del reporte técnico.
- **Emmanuel Alberto Mejía Arango -** [emmejiaa@unal.edu.co](mailto:emmejiaa@unal.edu.co) — Modelado matemático del problema combinatorio (TSP México), recolección de coordenadas geográficas de las 32 capitales y estructuración de la matriz de costos de la Parte 2; publicación del blog.
- **Juan Camilo López Morales** -  [jlopezmor@unal.edu.co](mailto:jlopezmor@unal.edu.co)  — Implementación del descenso por gradiente de la Parte 1, codificación de la colonia de hormigas (ACO) para el TSP y generación de los scripts de exportación de animaciones (.gif).
...
![dg_rosenbrock.gif](dg_rosenbrock.gif)
...
![dg_rastrigin.gif](dg_rastrigin.gif)
...
![pso_rosenbrock.gif](pso_rosenbrock.gif)
...
![pso_rastrigin.gif](pso_rastrigin.gif)
...
![dg_rosenbrock_3d.png](dg_rosenbrock_3d.png)

![pso_rastrigin_3d.png](pso_rastrigin_3d.png)
...
![convergencia_ga_vs_aco.png](convergencia_ga_vs_aco.png)
...
![ga_ruta_mexico.gif](ga_ruta_mexico.gif)
...
- **Región Central (Inicio)**
    
    Ciudad de México ➔ Toluca ➔ Morelia ➔ Colima ➔ Guadalajara ➔ Tepic
    
- **Península y Noroeste**
    
    La Paz ➔ Mexicali ➔ Hermosillo ➔ Chihuahua ➔ Culiacán ➔ Durango
    
- **Centro-Norte y Altiplano**
    
    Zacatecas ➔ Aguascalientes ➔ San Luis Potosí ➔ Saltillo ➔ Monterrey ➔ Ciudad Victoria
    
- **El Bajío y Eje Neovolcánico**
    
    Guanajuato ➔ Querétaro ➔ Pachuca ➔ Tlaxcala ➔ Puebla ➔ Xalapa
    
- **Sureste y Regreso por el Sur**
    
    Mérida ➔ San Francisco de Campeche ➔ Chetumal ➔ Villahermosa ➔ Tuxtla Gutiérrez ➔ Oaxaca ➔ Chilpancingo ➔ Cuernavaca ➔ **(Retorno a Ciudad de México)**
...
Dorigo, M., & Stützle, T. (2004). *Ant colony optimization*. MIT Press. [https://doi.org/10.7551/mitpress/1251.001.0001](https://doi.org/10.7551/mitpress/1251.001.0001)

Eiben, A. E., & Smith, J. E. (2015). *Introduction to evolutionary computing* (2nd ed.). Springer. [https://doi.org/10.1007/978-3-662-44874-8](https://doi.org/10.1007/978-3-662-44874-8)

Goldberg, D. E. (1989). *Genetic algorithms in search, optimization, and machine learning*. Addison-Wesley. [https://www.pearson.com/en-us.html](https://www.pearson.com/en-us.html)

Holland, J. H. (1975). *Adaptation in natural and artificial systems*. University of Michigan Press. [https://doi.org/10.7551/mitpress/1090.001.0001](https://doi.org/10.7551/mitpress/1090.001.0001)

Jamil, M., & Yang, X.-S. (2013). A literature survey of benchmark functions for global optimisation problems. *International Journal of Mathematical Modelling and Numerical Optimisation, 4*(2), 150–194. [https://doi.org/10.1504/IJMMNO.2013.055204](https://doi.org/10.1504/IJMMNO.2013.055204)

Kennedy, J., & Eberhart, R. (1995). Particle swarm optimization. En *Proceedings of the IEEE International Conference on Neural Networks* (pp. 1942–1948). IEEE. [https://doi.org/10.1109/ICNN.1995.488968](https://doi.org/10.1109/ICNN.1995.488968)
...
Lawler, E. L., Lenstra, J. K., Rinnooy Kan, A. H. G., & Shmoys, D. B. (Eds.). (1985). *The traveling salesman problem: A guided tour of combinatorial optimization*. Wiley. [https://www.wiley.com](https://www.wiley.com/)

Mühlenbein, H., Schomisch, M., & Born, J. (1991). The parallel genetic algorithm as function optimizer. *Parallel Computing, 17*(6–7), 619–632. [https://doi.org/10.1016/S0167-8191(06)80052-3](https://www.sciencedirect.com/science/article/abs/pii/S0167819105800523)

Nocedal, J., & Wright, S. J. (2006). *Numerical optimization* (2nd ed.). Springer. [https://doi.org/10.1007/978-0-387-40065-5](https://doi.org/10.1007/978-0-387-40065-5)

Rastrigin, L. A. (1974). *Systems of extremal control*. Nauka. 

Reinelt, G. (1994). *The traveling salesman: Computational solutions for TSP applications*. Springer. [https://doi.org/10.1007/BFb0032033](https://doi.org/10.1007/BFb0032033)

Rosenbrock, H. H. (1960). An automatic method for finding the greatest or least value of a function. *The Computer Journal, 3*(3), 175–184. [https://doi.org/10.1093/comjnl/3.3.175](https://doi.org/10.1093/comjnl/3.3.175)

Sinnott, R. W. (1984). Virtues of the Haversine. *Sky and Telescope, 68*(2), 159.

Storn, R., & Price, K. (1997). Differential evolution — A simple and efficient heuristic for global optimization over continuous spaces. *Journal of Global Optimization, 11*(4), 341–359. [https://doi.org/10.1023/A:1008202821328](https://doi.org/10.1023/A:1008202821328)